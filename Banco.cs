    ...
    internal class Banco
    {
        ...
        public static DataTable obterDadosAgen(string id)
        {
            ...
            try
            {
                ...
                cmd.CommandText = "SELECT * FROM tb_agen WHERE id_agen = " + id;
                Console.WriteLine("----------------------");
                Console.WriteLine(cmd.CommandText);
                Console.WriteLine(id);
                Console.WriteLine("----------------------");
        ...
        public static void AtualizarCon(Consulta consulta)
        {
            ...
            try
            {
                ...
                cmd.CommandText = "UPDATE tb_ SET  problema='" + consulta.prblema + "',solucao='" + consulta.solucao + "' WHERE con_id =" + consulta.con_id;
