...
namespace A3_2024._1
{
        internal class Banco
        {
            ...
            {
                conexao = new SQLiteConnection("Data Source = C:\\Users\\kaion\\source\\repos\\A3 2024.1\\banco\\bancoA3.db");
        ...
        public static DataTable obterAgenIDNome(string id)
        {
            ...
            try
            {
                ...
                cmd.CommandText = "SELECT  id_agen,horas,motivo FROM tb_agen WHERE vet_id = "+id;
